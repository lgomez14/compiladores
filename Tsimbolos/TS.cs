  ...
  public  class TS
    {
      ...
      public void inicialista()
      {
            ...
            TSimbolos.Add(ts5);
            tabla_de_simbolos ts6 = new tabla_de_simbolos("¬entero", "", -0, -0, -0, 6, "palabra reservada", "numero entero", "");
            TSimbolos.Add(ts6);
            tabla_de_simbolos ts7 = new tabla_de_simbolos("<#integer", "", -0, -0, -0, 7, "palabra reservada", "numero entero", "");
            TSimbolos.Add(ts7);
            tabla_de_simbolos ts8 = new tabla_de_simbolos("¬decimal", "", -0, -0, -0, 8, "palabra reservada", "numero con decimales", "");
            TSimbolos.Add(ts8);
            tabla_de_simbolos ts9 = new tabla_de_simbolos("¬constante", "", -0, -0, -0, 9, "palabra reservada", "cadena de caracteres", "");
            TSimbolos.Add(ts9);
            tabla_de_simbolos ts10 = new tabla_de_simbolos("¬bol", "", -0, -0, -0, 10, "palabra reservada", "booleano true o false", "");
            TSimbolos.Add(ts10);
            tabla_de_simbolos ts11 = new tabla_de_simbolos("¬boleano", "", -0, -0, -0, 11, "palabra reservada", "booleano true o false", "");
            TSimbolos.Add(ts11);
            ...
            TSimbolos.Add(ts14);
            tabla_de_simbolos ts15 = new tabla_de_simbolos("s/", "", -0, -0, -0, 15, "posicionador", "salto de linea en un texto", "");
            TSimbolos.Add(ts15);
